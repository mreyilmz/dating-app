...
export class MembersService {
  ...
  private getPaginationHeaders(pageNumber: number, pageSize: number) {
    let params = new HttpParams(); // HttpParams is a utility or a class provided by Angular that allows us to set query string parameters along with our HTTP request.
